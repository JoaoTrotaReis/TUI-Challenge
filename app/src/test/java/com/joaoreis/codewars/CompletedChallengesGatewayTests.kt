...
class CompletedChallengesGatewayTests {
    ...
    @Test
    fun `Given there are completed challenges in the API When completed challenges are requested Then return the list of completed challenges`() = runTest {
    ...
    @Test
    fun `Given there is a problem fetching completed challenges from the API When completed challenges are requested Then return error`() = runTest {
        val dispatcher = StandardTestDispatcher(testScheduler)
